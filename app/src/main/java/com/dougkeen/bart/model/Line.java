...
public enum Line {
    ...
    ORANGE(false, Station.BERY, Station.MLPT, Station.WARM, Station.FRMT,
            Station.UCTY, Station.SHAY, Station.HAYW, Station.BAYF, Station.SANL, Station.COLS,
            Station.FTVL, Station.LAKE, Station._12TH, Station._19TH, Station.MCAR,
    ...
    GREEN(true, Station.DALY, Station.BALB, Station.GLEN, Station._24TH,
            Station._16TH, Station.CIVC, Station.POWL, Station.MONT, Station.EMBR, Station.WOAK,
            Station.LAKE, Station.FTVL, Station.COLS, Station.SANL, Station.BAYF, Station.HAYW,
            Station.SHAY, Station.UCTY, Station.FRMT, Station.WARM, Station.MLPT, Station.BERY),
    ...
    PURPLE(false, Station.MLBR, Station.SFIA);
